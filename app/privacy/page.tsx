  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-3xl space-y-4 px-4 py-8 text-sm leading-relaxed [&_a]:underline [&_a]:underline-offset-2 [&_h1]:mb-2 [&_h1]:mt-6 [&_h1]:text-3xl [&_h1]:font-semibold [&_h2]:mt-8 [&_h2]:text-lg [&_h2]:font-semibold [&_li]:ml-5 [&_li]:list-disc [&_p]:mt-2 [&_ul]:mt-2">
        <h1>Privacy</h1>
        <p>
          Focus Realm is designed to collect <strong>nothing</strong> about you in the MVP. Your
          spirits, sessions, badges, and settings are stored entirely in this browser&apos;s{' '}
          <code>localStorage</code>. They never leave your device.
        </p>
        ...
        <p>
          ...
          erase the realm in one click.
        </p>
        <h2>Contact</h2>
        <p>
          For privacy questions email <code>privacy@focus-realm.app</code> (placeholder; replace
          before launch).
        </p>
      </main>
    </>
