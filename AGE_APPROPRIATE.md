...
- **Privacy by default.** No personal data is collected, transmitted, or
  sold. Everything stays on the user's device.
- **No dark patterns.** No FOMO timers, scarcity countdowns, or shame loops.
  Streaks reset gently and badges are kept forever.
- **No paid randomness.** Paid mechanics will be cosmetic only and never
  random. Several jurisdictions (Belgium, the Netherlands, increasingly the
  UK) classify paid loot boxes for minors as gambling — we don't go there.
- **Detrimental content avoided.** No targeted advertising, no chat with
...
The full policy will be published here before charging anyone.
